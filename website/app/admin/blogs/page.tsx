...
export default function BlogListPage() {
  ...
  const fetchBlogs = async () => {
    ...
    try {
     ...
     const response = await fetch(`${process.env.NEXT_PUBLIC_CMS_URL}/api/admin/blogs?${params}`);
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_CMS_URL}/api/admin/blogs/${deleteModal.blog._id}`, {
        method: 'DELETE',
      });
