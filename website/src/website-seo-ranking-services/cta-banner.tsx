          ...
          <div className="relative z-20 flex flex-col items-center text-center">
            ...
            <div className="flex flex-wrap justify-center gap-5">
              {data.buttons.map((text: string, i: number) => (
                <button
                  key={i}
                  className="h6 rounded-full border border-white/80 bg-[#3cb878] px-8 py-3.5 font-bold text-white shadow-sm backdrop-blur-md transition-all hover:scale-105 hover:bg-white/90 active:scale-95"
                >
                  {text}
                </button>
              ))}
