...
export default function AchievingFirstRank() {
  return (
          ...
          <div className="group relative w-full lg:w-[45%]">
            ...
            <div className=" relative z-10 rounded-[3.5rem]  p-2  transition-transform duration-700 group-hover:scale-[1.02]">
              <div className="overflow-hidden rounded-[3rem]">
                ...
                <img
                  src="/assets/images/website-ranking-services/first-rank-in-google.webp"
          ...
          <div className="w-full space-y-10 lg:w-[70%]">
            <div className="space-y-4">
              ...
              <h3 className="h3 leading-[0.95]  text-slate-900">
                Achieving
                <span className=" text-[#3cb878]"> First Rank in Google</span>
              </h3>
            </div>
            ...
            <div className="space-y-6">
              <p className="p leading-[2em] text-black">
                ...
                coveted first rank within 90 to 180 days. Our team of SEO
                experts use proven strategies and techniques to improve your
                website's ranking. We analyze your website, identify the areas
                that need improvement, and develop a customized plan to optimize
                your website's content and structure. Our focus is not just on
                improving your website's visibility, but also on increasing your
