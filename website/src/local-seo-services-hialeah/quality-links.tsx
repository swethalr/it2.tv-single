'use client';
/**
 * src/local-seo-services-hialeah/sections/QualityLinks.tsx
 *
 * Section 8: Boosting Authority With Quality Links
 * H3 heading + body paragraph
 */

import React from 'react';
import { motion } from 'framer-motion';
import { qualityLinksSection } from '../../data/local-seo-services-hialeah';

export function QualityLinks() {
  const d = qualityLinksSection;
