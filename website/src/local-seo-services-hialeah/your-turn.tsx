'use client';
/**
 * src/local-seo-services-hialeah/sections/YourTurn.tsx
 *
 * Section 10: Now It's Your Turn
 * Eyebrow + H3 + body paragraph + "Claim #1 Spot on Maps" button → checklist modal
 */

import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { Download } from 'lucide-react';
import { yourTurnSection } from '../../data/local-seo-services-hialeah';
import { ChecklistModal } from './shared';

export function YourTurn() {
  const [isFormOpen, setIsFormOpen] = useState(false);
  const d = yourTurnSection;
