'use client';
/**
 * src/local-seo-services-hialeah/sections/ContentStrategy.tsx
 *
 * Section 4: Content Strategy for Local Reach
 * Eyebrow + H3 + body + download button → checklist modal
 */

import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { Download } from 'lucide-react';
import { contentStrategySection } from '../../data/local-seo-services-hialeah';
import { ChecklistModal } from './shared';

export function ContentStrategy() {
  const [isFormOpen, setIsFormOpen] = useState(false);
  const d = contentStrategySection;
