'use client';
/**
 * src/local-seo-services-hialeah/sections/OnlineTrust.tsx
 *
 * Section 7: Creating Lasting Online Trust
 * H3 heading + body paragraph + premium image container with gradient overlay
 */

import React from 'react';
import { motion } from 'framer-motion';
import { onlineTrustSection } from '../../data/local-seo-services-hialeah';

export function OnlineTrust() {
  const d = onlineTrustSection;
