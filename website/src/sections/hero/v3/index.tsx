...
export function HeroSection({ title, breadcrumbItems }: HeroSectionProps) {
  return (
    <section className="section-padding-primary relative flex min-h-[450px] items-center">
      ...
      <Container>
        <div className="relative z-[4] flex flex-wrap items-center justify-between gap-x-20 gap-y-8 text-black/80  lg:pt-[137px]">
          <h1 className="h1 font-secondary font-bold lg:w-full">{title}</h1>
