        ...
        <div className="mt-16 grid grid-cols-2 gap-x-4 gap-y-12 md:grid-cols-3 lg:grid-cols-6">
          {services.map((service: any, index: number) => (
            ...
            >
              ...
              <div aria-hidden="true" className="flex h-20 w-20 items-center justify-center rounded-full bg-white text-[#3cb878] shadow-sm transition-colors duration-300 group-hover:bg-[#3cb878] group-hover:text-white">
                {service.icon}
              </div>
