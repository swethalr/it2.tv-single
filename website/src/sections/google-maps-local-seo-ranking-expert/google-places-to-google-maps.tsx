...
import { localSeoHistoryData } from '@/data/google-maps-local-seo';

export default function GoogleMapsLocalSeoRankingExpert() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const data = localSeoHistoryData;
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-12">
          ...
          <div className="group relative lg:col-span-5">
            <div className="absolute inset-0 rounded-3xl bg-white/20 blur-xl transition group-hover:opacity-100"></div>
            <img
              src={data.image}
