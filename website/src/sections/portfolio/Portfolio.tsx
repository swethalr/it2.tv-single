...
export default function PortfolioSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-transparent px-4 py-2">
          ...
          <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-12">
            ...
            <motion.div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 p-8 text-white shadow-2xl lg:col-span-7">
              ...
              <div className="mb-10 flex h-40 items-end justify-between gap-2 px-4">
                {[38, 45, 52, 50, 62, 75, 72, 88, 92, 98].map((h, i) => (
                  <motion.div
                    key={`${activeTab}-${i}`}
                    initial={{ height: 0 }}
                    animate={{ height: `${h}%` }}
              ...
              <div className="grid grid-cols-3 lg:gap-4 gap-2 text-center">
                {[
                  { l: 'Traffic', v: '+84%' },
                  { l: 'Leads', v: '+156%' },
                  { l: 'Sales', v: '+92%' },
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
            ...
            <div className="relative lg:col-span-7">
              <div className="relative aspect-[4/3] overflow-hidden rounded-[3rem] border border-slate-200 bg-slate-100 shadow-2xl">
                <AnimatePresence mode="popLayout">
                  ...
                  >
                    <Image
                      ...
                      alt={mapSteps[hoveredStep].alt || mapSteps[hoveredStep].title}
                      fill
                ...
                {/* Stats Bar */}
                <div className="absolute bottom-6 left-6 right-6 flex justify-around rounded-2xl border border-slate-100 bg-white/95 lg:p-5 shadow-lg backdrop-blur-md">
                  {[
                    { v: '98%', l: 'Reach' },
                    { v: '#1', l: 'Rank' },
                    { v: '2.4k', l: 'Views' },
