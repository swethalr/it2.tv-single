'use client';
/**
 * src/google-ranking-expert/sections/BottomContactForm.tsx
 *
 * Full-width split section: yellow image column (left) + green form column (right)
 */

import React from 'react';
import { ChevronDown } from 'lucide-react';
import ReCAPTCHA from 'react-google-recaptcha';
import { bottomFormSection } from '../../data/google-ranking-expert';
        ...
        <div className="w-full max-w-2xl rounded-[2.5rem] border-[3px] border-white/30 p-8 md:p-12">
          ...
          <form className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div className="flex justify-center py-2 md:col-span-2">
              <div className="scale-90 transform rounded-xl bg-white p-2 shadow-md scale-[0.75] md:scale-100">
                <ReCAPTCHA
            ...
            <button
              type="submit"
              className="mt-2 rounded-10 bg-[#FF5A2C] lg:py-5 p-2 font-bold uppercase tracking-wider text-white shadow-xl transition-all duration-300 hover:bg-slate-900 active:scale-95 md:col-span-2"
            >
              {d.submitLabel}
            </button>
          </form>
