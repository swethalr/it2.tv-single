...
const DiverseIndustries: React.FC = () => {
  return (
    <section className="relative overflow-hidden py-24 selection:bg-orange-100 lg:py-32">
          ...
          <div className="w-full space-y-10 lg:w-[60%]">
            ...
            <div className="space-y-6">
              <p className="p leading-relaxed text-black">
                Delving into Zammy's professional background, prior to starting
                his company he has worked with over 3000+ clients worldwide.
                From various leading advertising agencies across industries such
                as educational institutions, healthcare, tourism, construction
                and hyperlocal businesses located in numerous geographic
                regions. Spreading across India, Canada, United Kingdom, United
                States of America, Australia, Ireland, France, UAE, Malaysia,
                Cambodia, Germany, Singapore, Sweden, Switzerland, New Zealand,
                South Korea, Bahrain, Kuwait, Qatar, Oman, Saudi Arabia, Norway,
                Panama, Denmark, Finland and Mexico.
              </p>
            </div>
