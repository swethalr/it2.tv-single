'use client';
/**
 * src/local-seo-service-london/sections/Sidebar.tsx
 *
 * Sticky sidebar — 4 widgets:
 *  1. Free Website Audit magnet (green)
 *  2. Professional Network (social links)
 *  3. 45-Day Challenge trust badge
...
import { sidebar } from '../../data/local-seo-service-london';
