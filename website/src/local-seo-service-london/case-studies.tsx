'use client';
/**
 * src/local-seo-service-london/sections/CaseStudies.tsx
 *
 * Section 3: Real Results From Our Client
 * Swiper carousel of 3 result images + result paragraph + CTA → contact modal
 */
      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        >
          <Swiper
            ...
            className="overflow-hidden  border border-slate-100 bg-white shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)]"
          >
