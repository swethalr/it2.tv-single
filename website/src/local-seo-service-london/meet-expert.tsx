'use client';
/**
 * src/local-seo-service-london/sections/MeetExpert.tsx
 *
 * Section 4: Meet Our SEO Expert
 * Eyebrow + H2 + bio paragraph + download button → checklist modal
 */

import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { Download } from 'lucide-react';
import { meetExpertSection } from '../../data/local-seo-service-london';
import { ChecklistModal } from './shared';

export function MeetExpert() {
  const [isFormOpen, setIsFormOpen] = useState(false);
  const d = meetExpertSection;
