'use client';
/**
 * src/local-seo-service-london/sections/FaqSection.tsx
 *
 * Section 7: Frequently Asked Questions
 * Animated accordion with Sparkles badge header
 */

import React, { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { HelpCircle, ChevronDown, Sparkles } from 'lucide-react';
import { faqSection, faqData } from '../../data/local-seo-service-london';
                ...
                >
                  ...
                  <div
                    className={`transition-transform duration-500 ${
                      isOpen ? 'rotate-180 text-[#3cb878]' : 'text-slate-300'
                    }`}
                  >
                    <ChevronDown size={24} />
                  </div>
