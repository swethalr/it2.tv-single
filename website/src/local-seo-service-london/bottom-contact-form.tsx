'use client';
/**
 * src/local-seo-service-london/sections/BottomContactForm.tsx
 *
 * Full-width split section:
 *  Left  — yellow (#FFB400) image panel
 *  Right — green (#3cb878) form panel with ReCAPTCHA
 */

import React from 'react';
import { ChevronDown } from 'lucide-react';
import ReCAPTCHA from 'react-google-recaptcha';
import { bottomFormSection } from '../../data/local-seo-service-london';
