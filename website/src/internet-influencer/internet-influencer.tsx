...
export default function InternetInfluencer() {
  return (
          ...
          <div className="group relative w-full lg:w-[45%]">
            ...
            <div className=" relative z-10 rounded-[3.5rem]  p-2  transition-transform duration-700 group-hover:scale-[1.02]">
              <div className="overflow-hidden rounded-[3rem]">
                ...
                <img
                  src="/assets/images/internet-influencer/zammy-zaif.webp"
          ...
          <div className="w-full space-y-10 lg:w-[70%]">
            ...
            <div className="space-y-6">
              <p className="p leading-[2em] text-black">
                Zammy Zaif is a well-known internet influencer from Tirunelveli,
                Tamil Nadu. Since childhood, he had a special interest in
                computers and the internet, and he studied SEO and web design,
                realizing that this was his future. He did not discontinue his
                studies. Zammy was constantly looking into how to make a website
                more appealing and how to make money online. He is always eager
                to learn new things, and through hard work and dedication, Zammy
                has progressed to his current position. He has now been
                appointed as the CEO of BAMS Technology Pvt. Ltd. He was a
                leader in the field of search engine optimization tool.
              </p>
            </div>
            {/* Premium CTA Button */}
            <div className="pt-4">
